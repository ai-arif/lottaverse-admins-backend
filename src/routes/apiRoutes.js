...
const {createAdmin, adminLogin,changeAdminPassword,verifyAdminHudai}= require('../controllers/admin/authController');
...
// admin route
router.get("/admin/verify", verifyAdminToken, verifyAdminHudai);
